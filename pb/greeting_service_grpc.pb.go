...
type GreetingServiceClient interface {
	Hello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*Greeting, error)
}
...
func (c *greetingServiceClient) Hello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*Greeting, error) {
	out := new(Greeting)
	err := c.cc.Invoke(ctx, "/GreetingService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetingServiceServer interface {
	Hello(context.Context, *GreetingRequest) (*Greeting, error)
...
func (UnimplementedGreetingServiceServer) Hello(context.Context, *GreetingRequest) (*Greeting, error) {
...
func _GreetingService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/GreetingService/Hello",
	}
